...
from .schemas import TOOL_NAME, WEB_HEADERS_SCHEMA
...
def web_headers(args, **kwargs) -> str:
    """Run the read-only declared-HTTP-security-headers audit.
...
def register_all(ctx) -> None:  # noqa: ANN001 — PluginContext
    ...
    try:
        ...
        logger.warning(
            "pcs-security-web-headers: pcs-security-core is unavailable (%s). %s will register "
